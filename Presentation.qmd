...
-   **BNE**: Bruttonationaleinkommen - BIP zzgl. Saldo der Primäreinkommen (Inländerprinzip)

-   **NNE**: Nettonationaleinkommen - BNE abzüglich Abschreibungen
...
-   **Spearman-(Rang-)Korrelation**: misst *Monotonie* des Zusammenhangs - definiert durch 
...
Lediglich für Afghanistan und das Vereingte Königreich fehlen einige Beobachtungen bezüglich des NNE pro Kopf.
...
-   Eine hohe Staatsverschuldung hat keinen Zusammenhang mit einer geringen Bildungsquote
