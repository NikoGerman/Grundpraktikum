...
Q1_plots <- Q1(readRDS("Data/cleaned/Worldbank.RDS"))
...
Q2_plots <- Q2(readRDS("Data/cleaned/Worldbank.RDS"))
...
Q3_plots <- Q3(readRDS("Data/cleaned/Worldbank.RDS"))
...
Q4_plots <- Q4(readRDS("Data/cleaned/Worldbank.RDS"))
...
Q5_plots <- Q5(readRDS("Data/cleaned/Worldbank.RDS"))
Q5_plots$plot1
```
...
aggr_examples(readRDS("Data/cleaned/Worldbank.RDS"))
```
...
dfg <- readRDS("Data/cleaned/Worldbank.RDS") %>%
  group_by(Income_Group) %>%
  summarise(Countries = paste(unique(Country_Name), collapse = ", "), .groups = 'drop')

knitr::kable(dfg, col.names = c("Klassifizierung", "Länder"), format = "html", align = c("l", "r")) %>%
